...
class Messages extends Translations {
  ...
  Map<String, Map<String, String>> get keys => {
    'ar': {
      ...
      'notifications_history_title': 'الإشعارات والتحذيرات',
      'no_notifications': 'لا توجد إشعارات حالياً',
      'no_reports_yet': 'لم تقدم أي بلاغات بعد',
      'no_reports_with_status': 'لا توجد بلاغات بهذه الحالة',
      'report_no_desc': 'لا يوجد وصف',
      'now': 'الآن',
      ...
      'safety_guide': 'إرشادات الأمان',
      'safety_guide_desc': 'دليل السلامة والإجراءات الوقائية',
      'faq_title': 'الأسئلة الشائعة',
      'faq_desc': 'إجابات لأكثر الأسئلة تكراراً',
      ...
      'location_fetch_error': 'فشل في الحصول على الموقع',
      ...
      'enter_new_password_desc': 'الرجاء إدخال كلمة المرور الجديدة',
      ...
      'password_min_length_error': 'كلمة المرور يجب أن تكون 6 أحرف على الأقل',
    ...
    'en': {
      ...
      'account': 'Account',
      'settings_menu':
          'Settings', // Renamed to avoid key conflict with existing 'settings'
      'support': 'Support',
      ...
      'last_name': 'Last Name',
      'notifications_history_title': 'Notifications & Alerts',
      'no_notifications': 'No notifications right now',
      'no_reports_yet': 'No reports submitted yet',
      'no_reports_with_status': 'No reports with this status',
      'report_no_desc': 'No description',
      'now': 'Now',
      ...
      'safety_guide_desc': 'Safety guide and preventive measures',
      'faq_title': 'FAQ',
      ...
      'location_fetch_error': 'Failed to get location',
      ...
      'enter_new_password_desc': 'Please enter your new password',
